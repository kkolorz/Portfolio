    ...
    <nav className={
        ...
        <div className='max-w-[1200px] w-[1200px] h-full flex justify-between items-center px-4'>
            ...
            {/* Desktop menu */}
                ...
                <Link to="home" spy={true} smooth={true} offset={-120} duration={500} className="nav-item hover:text-[#BF91FA] hover:scale-[1.04] duration-200">
                    Home
                </Link>
                <Link to="about" spy={true} smooth={true} offset={-120} duration={500} className="nav-item hover:text-[#BF91FA] hover:scale-[1.04] duration-200">
                    About Me
                </Link>
                <Link to="skills" spy={true} smooth={true} offset={-120} duration={500} className="nav-item hover:text-[#BF91FA] hover:scale-[1.04] duration-200">
                    Skills
                </Link>
                <Link to="projects" spy={true} smooth={true} offset={-120} duration={500} className="nav-item hover:text-[#BF91FA] hover:scale-[1.04] duration-200">
                    Projects
                </Link>
