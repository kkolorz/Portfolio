  ...
  return (
    <div className='w-full h-screen'>
        <div className='max-w-[1200px] h-full mx-auto px-6 flex flex-col justify-center items-start md:pl-[200px]'>
            <p className='text-xl sm:text-xl text-white py-1'><span className='text-[#BF91FA]'>Hello there,</span> my name is</p>
            <h1 className='text-4xl sm:text-5xl md:text-6xl text-white py-2 font-semibold'>Karol Kolorz</h1>
            <h2 className='text-4xl sm:text-5xl md:text-[3.5rem] text-white py-3 font-semibold'><span className='text-[#BF91FA]'>I'm </span>Front-End Developer</h2>
            <p className='text-white text-[1.1rem] py-2 max-w-[750px]'>
            ...
            <p className='text-white text-[1.1rem] py-3'>
                Let's meet!</p>
